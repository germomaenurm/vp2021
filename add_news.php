<?php
    ...
    if(isset($_POST["news_submit"])){
		//uudisele võib aga ei pea lisama pilti
		//kui pilt on valitud tasub see kõige esimesene serverisse salvestada ja andmebaasi lisada
		//just lisatud kirje id saab kätte:	$added_id = $conn->insert_id;
		//siis saate uudise enda koos tema foto idga salvestada.
